...
net.compile(loss=HuberLoss(2.0), optimizer=keras.optimizers.Nadam(), metrics=['mae'])
net.fit(X_train_scaled, y_train, validation_data=(X_valid_scaled, y_valid), epochs=2, workers=0, )


net.save('model_with_custom_loss_class.h5')

# net = keras.models.load_model('model_with_custom_loss_class.h5', custom_objects={
#                               'huber_fn': HuberLoss(2.0)})
